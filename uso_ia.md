...
* *"Gere uma rotina em Python pura que imprima uma lista simulando a fita da máquina de turing do arquivo anexado, destacando a posição do índice atual entre colchetes."*

### 4. Declaração de Autoria e Revisão
Declaramos que todos os integrantes da equipe revisaram o código gerado, compreendem a totalidade das transições dos modelos lógicos implementados e estão aptos a responder quaisquer arguições técnicas durante o seminário presencial.